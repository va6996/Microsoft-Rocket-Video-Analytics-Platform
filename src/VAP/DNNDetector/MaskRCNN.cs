...
namespace DNNDetector
{
    public class MaskRCNNOnnx
    {
        ...
        public MaskRCNNOnnx(List<Tuple<string, int[]>> lines, string modelName, DNNMode mode)
        {
            _lines = lines;
            onnxWrapper = new OnnxWrapper($@"modelOnnx/{modelName}ort.onnx", mode);
        }
